...
export function Navbar() {
  const openGleap = useCallback((e: React.MouseEvent) => {
    e.preventDefault()
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-8">
            ...
            <button
              onClick={openGleap}
              className="text-xs font-medium text-white bg-[#111] hover:bg-[#333] px-5 py-2 rounded-full transition-colors duration-200 cursor-pointer"
            >
              Contact
            </button>
          </div>
