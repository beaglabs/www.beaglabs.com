                    ...
                    {section.items.map((item, j) =>
                      typeof item === "string" ? (
                        <li key={j} className="flex items-start gap-3">
                          <span className="font-mono text-xs text-[#b3ddbb]/30 mt-0.5">
                            —
                          </span>
                          <span className="font-mono text-sm text-[#b3ddbb]/60">
                            {item}
                          </span>
                        </li>
                      ) : (
