...
| Resource | Projected Annual Consumption (2030) | Comparison |
|----------|-----------------------------------|------------|
| Electricity | 448 TWh | Exceeds France, UK, and Italy combined |
| CO₂ equivalent | 208 million metric tons | Annual emissions of 45 million passenger vehicles |
| Water for cooling | 1.2 trillion gallons | A single data center campus consumes as much as a small city |
...
The IEA explicitly acknowledges this dynamic in its AI energy projections, noting that efficiency improvements in AI hardware are unlikely to slow total electricity demand growth for data centers.
